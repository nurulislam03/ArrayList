...
public class Perpustakaan {
   ...
   int keluar = 0;
        ...
        dataMahasiswa.add(new Mahasiswa("20200040017", "Risa Salsabila"));
        dataMahasiswa.add(new Mahasiswa("20200040079", "Nurul Islam Hasanah"));
        dataMahasiswa.add(new Mahasiswa("20200040012", "Evi Septiyani"));
        dataMahasiswa.add(new Mahasiswa("20200040043", "Siti Nurjanah"));

        ArrayList <Buku> dataBuku = new ArrayList<>();

        dataBuku.add(new Buku("001", "Negeri 5 Menara"));
        dataBuku.add(new Buku("002", "Laskar Pelangi"));
        dataBuku.add(new Buku("003", "Sang Pemimpi"));
        dataBuku.add(new Buku("004", "Bumi Manusia"));
